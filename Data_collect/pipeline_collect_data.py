...
def fetch_and_store():
    ...
    for query in CATEGORY:
        url = f"https://newsapi.org/v2/top-headlines?q={query}&sortBy=Popularity&language=en&pageSize=100&apiKey={API_KEY_NEWS}"
            ...
            cursor_connect.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s, %s, %s)
                    ...
                    """, (
                        ...
                        article["source"]["name"],
                        query  # Utiliser la requête comme catégorie
                    ))
